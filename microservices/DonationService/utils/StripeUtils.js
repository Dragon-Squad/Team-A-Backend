...
function createSessionConfig(customerId, monthlyDonationId, personalMessage, projectId, amount, userId, donorType, userEmail) {
...
async function createDonationSession(customerId, monthlyDonationId, unitAmount, personalMessage, projectId, userId, donorType, userEmail) {
    ...
    let sessionConfig = createSessionConfig(customerId, monthlyDonationId, personalMessage, projectId, unitAmount, userId, donorType, userEmail);
