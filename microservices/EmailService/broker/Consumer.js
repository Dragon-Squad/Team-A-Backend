      ...
      eachMessage: async ({ key, message }) => {
        try {
          ...
          if (value) {
            switch (key) {
              case "create_project":
                await EmailExternalService.sendCharityProjectCreatedEmail(value);
                await EmailExternalService.sendDonorProjectCreatedEmail(value);
                break;

              case "halt_project":
                await EmailExternalService.sendCharityProjectHaltedEmail(value);
                await EmailExternalService.sendDonorProjectHaltedEmail(value);
                break;
